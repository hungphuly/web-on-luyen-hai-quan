...
|---|---|---|
| Framework | Next.js 14 (App Router) + TypeScript strict | Server Component mặc định, phù hợp yêu cầu "đáp án chỉ ở Server" |
...
| PWA | next-pwa hoặc Serwist | Học viên thêm vào màn hình chính, dùng như app |
...
| 3 | Học liệu tĩnh: `/bai-giang/video` (nhúng YouTube unlisted), `/bai-giang/ly-thuyet` (nội dung markdown tĩnh) | Chỉ hiển thị nội dung, không chấm điểm, không RLS phức tạp |
...
```
Khởi tạo project Next.js 14 App Router + TypeScript strict + TailwindCSS + shadcn/ui.
